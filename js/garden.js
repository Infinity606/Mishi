		...
		Garden.randomrgba = function () {
			// Generate purple shades: red + blue, minimal green
			var r = Math.round(Garden.random(100, 200));  // Red range
			var g = Math.round(Garden.random(0, 40));     // Very low green
			var b = Math.round(Garden.random(150, 255));  // Blue range
			var a = 0.6; // transparency
